    ...
    return (
        <View style={myContainer.body}>
            <View style={styles.infoItinerary}>
                <Avatar.Image size={85} source={{ uri: itinerary.autorFotoHost }} style={{ width: 85, height: 85, marginRight: 30 }} />
                <View>
            ...
            <ScrollView horizontal={true} style={{marginTop:20}}>
                {itinerary.activities.map((activity,index)=> {
                    return (
                        <TouchableRipple key={activity._id}  onPress = {()=>{setStateImageView({
                            ...stateImageView,
                            index,
                            visible:true
                        })}}>
